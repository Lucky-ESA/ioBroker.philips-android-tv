...
module.exports = {
    ...
    async createSettings(id, struct) {
        let common = {};
        common = {
            name: {
                en: "Settings",
            ...
            if (struct.node.data.nodes[node_json].data.nodes) {
                for (const ambi of struct.node.data.nodes[node_json].data.nodes) {
                    ...
                    if (ambi.context) {
                        ...
                        this.log.info("AMBI: " + JSON.stringify(ambi));
                        if (ambi.data.colors) {
                            this.log.info("COLORS: " + JSON.stringify(ambi.data.colors));
                ...
                this.log.info("STRUCT: " + JSON.stringify(struct.node.data.nodes[node_json]));
            }
        }
    },
