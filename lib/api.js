...
class Philips extends EventEmitter {
    ...
    startMulticast() {
        mdns.on("response", (response) => {
            if (
                ...
                this.adapter.log.debug(`Device ${this.ip} is online`);
                this.updateData();
    ...
    startNotifychange() {
            ...
            notification: {
                ...
                "network/devices": [
                    ...
                    },
                    {
                        ...
                        type: "Ethernet",
                        ip: "2001:9e8:d6cd:1b00:cbe:bda8:1f17:8154",
                        "wake-on-lan": "Enabled",
                    },
                ],
                "input/textentry": {
        ...
        //],
        this.notifyInterval = this.adapter.setInterval(async () => {
            this.requestClient
